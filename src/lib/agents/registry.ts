...
export const AGENT_REGISTRY: AgentDefinition[] = [
  ...
  {
    id: "failure_synthesizer",
    role: "failure_synthesizer",
    label: "Failure Synthesizer",
    shortLabel: "FS",
    layer: "Band only",
    question: "Where did it fail, what class, which layer owns the fix?",
    accentClass: "text-command",
    borderClass: "border-command/40",
    glowClass: "shadow-glow-command",
    messageType: "failure_synthesis",
    order: 4,
    enabled: false,
  },
];
